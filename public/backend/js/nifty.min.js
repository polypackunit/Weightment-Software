...
!(function (n, e) {
    ...
    return (function (n) {
        var e = "metisMenu",
            s = n.fn[e],
            a = { toggle: !0, preventDefault: !0, activeClass: "active", collapseClass: "collapse", collapseInClass: "in", collapsingClass: "collapsing", triggerElement: "a", parentTrigger: "li", subMenu: "ul" },
            r = { SHOW: "show.metisMenu", SHOWN: "shown.metisMenu", HIDE: "hide.metisMenu", HIDDEN: "hidden.metisMenu", CLICK_DATA_API: "click.metisMenu.data-api" },
            o = (function () {
                function e(n, e) {
                                ...
                                .on(r.CLICK_DATA_API, function (i) {
                                    ...
                                    t.preventDefault && i.preventDefault(),
                                        "true" !== s.attr("aria-disabled") &&
                                            (a.hasClass(t.activeClass) ? (s.attr("aria-expanded", !1), e.hide(o)) : (e.show(o), s.attr("aria-expanded", !0), t.toggle && r.attr("aria-expanded", !1)),
                    ...
                    (s.show = function (e) {
                        ...
                        if (!this.transitioning && !n(e).hasClass(this.config.collapsingClass)) {
                            ...
                            if ((s.trigger(a), !a.isDefaultPrevented())) {
                                s.parent(this.config.parentTrigger).addClass(this.config.activeClass),
                                    this.config.toggle &&
                                        this.hide(
                                            s
                                    ...
                                    s.removeClass(this.config.collapseClass).addClass(this.config.collapsingClass).height(0),
                    ...
                    (s.hide = function (e) {
                        ...
                        if (!this.transitioning && n(e).hasClass(this.config.collapseInClass)) {
                            var s = n(e),
                                a = n.Event(r.HIDE);
                            if ((s.trigger(a), !a.isDefaultPrevented())) {
                                s.parent(this.config.parentTrigger).removeClass(this.config.activeClass),
                                    s.height(s.height())[0].offsetHeight,
                                    s.addClass(this.config.collapsingClass).removeClass(this.config.collapseClass).removeClass(this.config.collapseInClass),
                                    this.setTransitioning(!0);
                                var o = function () {
                                    t.config &&
                                        t.element &&
                                        ...
                                        t.setTransitioning(!1),
                                        s.trigger(r.HIDDEN),
                                        s.removeClass(t.config.collapsingClass).addClass(t.config.collapseClass).attr("aria-expanded", !1));
                                };
...
!(function (n) {
        ...
        n(document).on("nifty.ready", function () {
            ...
            n("body")
                ...
                .on("clickortap click", function (a) {
                    n(a.target).hasClass("search-container") && n(a.target).collapse("hide"),
                        s.hasClass("mainnav-in") && (s.hasClass("manual-nav-toggle") || 0 != n(a.target).closest("#mainnav-menu-wrap").length || 0 != n(a.target).closest(".mainnav-toggle").length || n.niftyNav("toggle")),
                        s.hasClass("aside-in") &&
                            s.hasClass("aside-float") &&
                            (s.hasClass("manual-aside-toggle") || 0 != n(a.target).closest("#aside-container").length || 0 != n(a.target).closest(".aside-toggle").length || n.niftyAside("toggleHideShow"));
                })
    ...
    !(function (n) {
        ...
        var a = null,
            ...
            i = function (a) {
                a.css({ "margin-top": "0px", opacity: 1, display: "block" }).animate({ "margin-top": "15px", opacity: 0 }, 250, function () {
    ...
    !(function (n) {
        "use strict";
        n(document).on("nifty.ready", function () {
            var a = { closeBtn: n('[data-dismiss="panel"], [data-panel="dismiss"]'), minMaxBtn: n('[data-panel="minmax"]'), fullScreen: n('[data-panel="fullscreen"]') };
            a.closeBtn.length &&
                ...
                a.minMaxBtn.length &&
                    a.minMaxBtn.each(function () {
                        ...
                        a.prop("id") || a.prop("id", "panel-collapse-" + ((65536 * (1 + Math.random())) | 0).toString(16).substring(1)),
                            n(this).attr({ "data-target": "#" + a.prop("id"), "data-toggle": "collapse" }),
        ...
        n.niftyNoty = function (f) {
            var u,
                ...
                C = function () {
                    return (
                        g.onHide(),
                        "floating" === g.container && g.floating.animationOut && (p.removeClass(g.floating.animationIn).addClass(g.floating.animationOut), d || (g.onHidden(), p.remove())),
                        p.removeClass("in").on("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd", function (n) {
            ...
            if (c) {
                if ((e.append(p.html(h)), p.find('[data-dismiss="noty"]').one("click", C), g.closeBtn && p.find(".close").one("click", C), g.timer > 0 && (u = setInterval(C, g.timer)), !g.focus))
    ...
    !(function (n) {
        ...
        var a = null,
                        ...
                        o
                            .popover({
                                ...
                                content: function () {
                                    ...
                                    return (
                                        g
                                            ? ((a = n('<div class="sub-menu"></div>')), l.addClass("pop-in").wrap('<div class="nano-content"></div>').parent().appendTo(a))
                                            : r.length
                                            ? ((a = n('<div class="sidebar-widget-popover"></div>')), r.wrap('<div class="nano-content"></div>').parent().appendTo(a))
                                            : (a = '<span class="single-content">' + s.html() + "</span>"),
                                        a
                                    );
                                },
                            ...
                            .on("shown.bs.popover", function () {
                                ...
                                u.find(".nano-content").children().css("height", ""),
                                    t > l
                                        ? (f.length && !f.is(":visible") && (s = Math.round(0 - 0.5 * s)),
                                          (t -= 5),
                                          u
                                          ...
                                          m(u.find(".nano")))
                                        : (!e.hasClass("navbar-fixed") && i.hasClass("affix-top") && (l -= 50),
                                          c > l
                                              ? ((e.hasClass("navbar-fixed") || i.hasClass("affix-top")) && (l -= s + 5),
                                                (l -= 5),
                                                u
                                                    ...
                                                    .nanoScroller({ preventPageScrolling: !0 }),
                                                m(u.find(".nano")))
                                              : (f.length && !f.is(":visible") && (s = Math.round(0 - 0.5 * s)), u.css({ top: s + "px", bottom: "", height: "auto" }))),
            ...
            m = function () {
                var a,
                    t = e.width();
                (a = 740 >= t ? "xs" : t > 740 && 992 > t ? "sm" : t >= 992 && 1200 >= t ? "md" : "lg"),
                    f != a &&
                        ((f = a),
                        (d = a),
                        "sm" == d && e.hasClass("mainnav-lg")
                            ...
                            ? e.removeClass("mainnav-sm mainnav-out mainnav-lg").addClass("mainnav-sm lg-mainnav-lg")
                            : ("md" != d && "lg" != d) || !e.hasClass("lg-mainnav-lg") || (e.removeClass("lg-mainnav-lg"), n.niftyNav("expand")));
            },
            h = function () {
                if (!v)
                    try {
            ...
            C = function () {
                ...
                return (
                    ...
                    "collapse" == r || e.hasClass("mainnav-sm") ? (e.removeClass("mainnav-in mainnav-out mainnav-lg"), c || g()) : c && p(),
                    (s = n("#mainnav").height()),
                    (r = !1),
                    null
                );
            ...
            y = {
                ...
                bind: function () {
                    ...
                    (a = n('#mainnav-menu > li > a, #mainnav-menu-wrap .mainnav-widget a[data-toggle="menu-widget"]')),
                        (e = n("#container")),
                        (t = e.children(".boxed")),
        ...
        n.niftyNav = function (n, a) {
            if (y[n]) {
                ("colExpToggle" != n && "expand" != n && "collapse" != n) ||
                    ("xs" == d && "collapse" == n ? (n = "pushOut") : ("xs" != d && "sm" != d) || ("colExpToggle" != n && "expand" != n) || !e.hasClass("mainnav-sm") || (n = "pushIn"));
                ...
                (t =
                    a.hasClass("boxed-layout") && a.hasClass("aside-fixed") && s.length
                        ? a.hasClass("aside-left")
                            ? { "-ms-transform": "translateX(" + s.offset().left + "px)", "-webkit-transform": "translateX(" + s.offset().left + "px)", transform: "translateX(" + s.offset().left + "px)" }
                            : { "-ms-transform": "translateX(" + (0 - s.offset().left) + "px)", "-webkit-transform": "translateX(" + (0 - s.offset().left) + "px)", transform: "translateX(" + (0 - s.offset().left) + "px)" }
                        : { "-ms-transform": "", "-webkit-transform": "", transform: "", right: "" }),
                    e.css(t);
            },
            r = function () {
    ...
    !(function (n) {
            ...
            l = function (n) {
                clearInterval(s),
                    (s = setInterval(function () {
                        n[0] == a[0] ? i.nanoScroller({ flash: !0, preventPageScrolling: !!t.hasClass("mainnav-fixed") }) : n[0] == e[0] && o.nanoScroller({ preventPageScrolling: !!t.hasClass("aside-fixed") }), clearInterval(s), (s = null);
                    }, 500));
            },
            r = function () {
                (t = n("#container")),
        ...
        n.fn.niftyAffix = function (a) {
            return this.each(function () {
                var e,
                    i = n(this);
                "object" != typeof a && a ? ("update" == a ? (i.data("nifty.af.class") || r(), (e = i.data("nifty.af.class")), l(i)) : "bind" == a && r()) : ((e = a.className), i.data("nifty.af.class", a.className)),
