!(function (n) {
    ...
    function y(t) {
        var e = qt.defaults.oLanguage,
            n = t.sZeroRecords;
        !t.sEmptyTable && n && "No data available in table" === e.sEmptyTable && Pt(t, t, "sZeroRecords", "sEmptyTable"),
            !t.sLoadingRecords && n && "Loading..." === e.sLoadingRecords && Pt(t, t, "sZeroRecords", "sLoadingRecords"),
    ...
    function s(t, e, n, a) {
        var r,
            ...
            h = function (t) {
                (n !== j && n !== u) ||
                    ((o = c[u]), (i = P.trim(t.innerHTML)), o && o._bAttrSrc ? (p(o.mData._)(a, i), d(o.mData.sort, t), d(o.mData.type, t), d(o.mData.filter, t)) : f ? (o._setter || (o._setter = p(o.mData)), o._setter(a, i)) : (a[u] = i)),
                    u++;
            };
    ...
    function g(t, e, n, a) {
        var r,
            ...
            f = [];
        if (null === u.nTr) {
            for (r = n || S.createElement("tr"), u.nTr = r, u.anCells = f, r._DT_RowIndex = e, d(t, u), l = 0, s = t.aoColumns.length; l < s; l++)
                (i = t.aoColumns[l]),
                    ((o = n ? a[l] : S.createElement(i.sCellType))._DT_CellIndex = { row: e, column: l }),
                    f.push(o),
    ...
    function d(t, e) {
        ...
        if (n) {
            var r = t.rowIdFn(a);
            r && (n.id = r),
                a.DT_RowClass && ((r = a.DT_RowClass.split(" ")), (e.__rowc = e.__rowc ? se(e.__rowc.concat(r)) : r), P(n).removeClass(e.__rowc.join(" ")).addClass(a.DT_RowClass)),
    ...
    function b(t) {
        ...
        for (s && (r = P("<tr/>").appendTo(i)), e = 0, n = c.length; e < n; e++)
            (o = c[e]),
                ...
                s && a.appendTo(r),
                t.oFeatures.bSort && (a.addClass(o.sSortingClass), !1 !== o.bSortable && (a.attr("tabindex", t.iTabIndex).attr("aria-controls", t.sTableId), Ct(t, o.nTh, e))),
        ...
        if (-1 !== P.inArray(!1, e)) dt(t, !1);
            ...
            if (0 !== s.length)
                ...
                (n = o.sZeroRecords),
                    ...
                    (e[0] = P("<tr/>", { class: r ? a[0] : "" }).append(P("<td />", { valign: "top", colSpan: v(t), class: t.oClasses.sRowEmpty }).html(n))[0]);
            kt(t, "aoHeaderCallback", "header", [P(t.nTHead).children("tr")[0], h(t), i, u, s]),
                kt(t, "aoFooterCallback", "footer", [P(t.nTFoot).children("tr")[0], h(t), i, u, s]),
    ...
    function t(t) {
        ...
        for (e = 0; e < i; e++)
            (a = o[e]),
                ...
                h.columns.push({ data: n, name: a.sName, searchable: a.bSearchable, orderable: a.bSortable, search: { value: r.sSearch, regex: r.bRegex } }),
                d("mDataProp_" + e, n),
                l.bFilter && (d("sSearch_" + e, r.sSearch), d("bRegex_" + e, r.bRegex), d("bSearchable_" + e, a.bSearchable)),
    ...
    function G(n) {
        var t = n.oClasses,
            ...
            s =
                ((t = P("<div/>", { id: o.f ? null : e + "_filter", class: t.sFilter }).append(P("<label/>").append(l))),
                (o = function () {
    ...
    function $(t, e, n) {
        ...
        if ((i(t), "ssp" != Wt(t))) {
            for (Z(t, e.sSearch, n, e.bEscapeRegex !== j ? !e.bEscapeRegex : e.bRegex, e.bSmart, e.bCaseInsensitive), o(e), e = 0; e < r.length; e++)
                Y(t, r[e].sSearch, e, r[e].bEscapeRegex !== j ? !r[e].bEscapeRegex : r[e].bRegex, r[e].bSmart, r[e].bCaseInsensitive);
            z(t);
        } else o(e);
        ...
        for (e = !1, n = 0, r = t.aoData.length; n < r; n++)
            if (!(s = t.aoData[n])._aFilterData) {
                for (i = [], a = 0, o = u.length; a < o; a++)
                    (e = u[a]).bSearchable ? ((l = R(t, n, a, "filter")), c[e.sType] && (l = c[e.sType](l)), null === l && (l = ""), "string" != typeof l && l.toString && (l = l.toString())) : (l = ""),
    ...
    function st(a) {
        for (
            var t = a.oClasses, e = a.sTableId, n = a.aLengthMenu, r = (o = P.isArray(n[0])) ? n[0] : n, o = ((n = o ? n[1] : n), P("<select/>", { name: e + "_length", "aria-controls": e, class: t.sLengthSelect })), i = 0, l = r.length;
            i < l;
            i++
        )
            ...
            (l = P("<div/>", { class: r.sScrollWrapper })
                .append(
                    P("<div/>", { class: r.sScrollHead })
                        .css({ overflow: "hidden", position: "relative", border: 0, width: n ? (n ? Dt(n) : null) : "100%" })
                        .append(
                            P("<div/>", { class: r.sScrollHeadInner })
                                .css({ "box-sizing": "content-box", width: e.sXInner || "100%" })
                                .append(
                                    l
                                        .removeAttr("id")
                                        .css("margin-left", 0)
                ...
                .append(
                    P("<div/>", { class: r.sScrollBody })
                        .css({ position: "relative", overflow: "auto", width: n ? Dt(n) : null })
                        .append(c)
                )),
            u &&
                l.append(
                    P("<div/>", { class: r.sScrollFoot })
                        .css({ overflow: "hidden", border: 0, width: n ? (n ? Dt(n) : null) : "100%" })
                        .append(
        ...
        (e = p.scrollHeight > p.clientHeight),
            n.scrollBarVis !== e && n.scrollBarVis !== j
                ...
                : ((n.scrollBarVis = e),
                  ...
                  T && ((a = T.clone().prependTo(D)), (t = T.find("tr")), (a = a.find("tr"))),
                  ...
                  (c = D.outerWidth()),
                  "" === i
                      ? ((_.width = "100%"), C && (D.find("tbody").height() > p.offsetHeight || "scroll" == g.css("overflow-y")) && (_.width = Dt(D.outerWidth() - u)), (c = D.outerWidth()))
                  ...
                  D.outerWidth() < c
                      ? ((t = p.scrollHeight > p.offsetHeight || "scroll" == g.css("overflow-y") ? c + u : c),
                        C && (p.scrollHeight > p.offsetHeight || "scroll" == g.css("overflow-y")) && (_.width = Dt(t - u)),
                  ...
                  (d[(s = "padding" + (w.bScrollbarLeft ? "Left" : "Right"))] = l ? u + "px" : "0px"),
    ...
    function yt(t) {
        ...
        for (
            ...
            for (e = 0, n = (a = s[(i = u[t][0])].aDataSort).length; e < n; e++)
                (o = s[(r = a[e])].sType || "string"), u[t]._idx === j && (u[t]._idx = P.inArray(u[t][1], s[r].asSorting)), l.push({ src: i, col: r, dir: u[t][1], index: u[t]._idx, type: o, formatter: qt.ext.type.order[o + "-pre"] });
        return l;
    }
    function _t(t) {
        var e,
    ...
    function Tt(t) {
        for (var e, n, a = t.aoColumns, r = yt(t), o = ((t = t.oLanguage.oAria), 0), i = a.length; o < i; o++) {
            ...
            s.removeAttribute("aria-sort"),
                n.bSortable &&
                    (0 < r.length && r[0].col == o ? (s.setAttribute("aria-sort", "asc" == r[0].dir ? "ascending" : "descending"), (n = l[r[0].index + 1] || l[0])) : (n = l[0]), (e += "asc" === n ? t.sSortAscending : t.sSortDescending)),
        ...
        "number" == typeof r[0] && (r = t.aaSorting = [r]),
            n && t.oFeatures.bSortMulti
                ? -1 !== (n = P.inArray(e, re(r, "0")))
                    ? (null === (e = i(r[n], !0)) && 1 === r.length && (e = 0), null === e ? r.splice(n, 1) : ((r[n][1] = o[e]), (r[n]._idx = e)))
    ...
    function Et(t, e) {
        ...
        return (
            e <= n
                ...
                : (e - 1 - a <= t ? (n = ie(e - (n - 2), e)) : ((n = ie(t - a + 2, t + a - 1)).push("ellipsis"), n.push(e - 1)), n.splice(0, 0, "ellipsis"), n.splice(0, 0, 0)),
            (n.DT_el = "span"),
            n
        );
    }
                ...
                this.each(function () {
                    ...
                    if ("table" != this.nodeName.toLowerCase()) Rt(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                        ...
                        P.extend(f, qt.ext.classes, a.oClasses),
                            i.addClass(f.sTable),
                            c.iInitDisplayStart === j && ((c.iInitDisplayStart = a.iDisplayStart), (c._iDisplayStart = a.iDisplayStart)),
                            null !== a.iDeferLoading &&
                                ((c.bDeferLoading = !0), (t = P.isArray(a.iDeferLoading)), (c._iRecordsDisplay = t ? a.iDeferLoading[0] : a.iDeferLoading), (c._iRecordsTotal = t ? a.iDeferLoading[1] : a.iDeferLoading));
                        var d = c.oLanguage;
                        ...
                        if (
                            ...
                            (t = []),
                            0 !== (l = this.getElementsByTagName("thead")).length && (B(c.aoHeader, l[0]), (t = U(c))),
                            null === a.aoColumns)
                        )
                            ...
                            P(h[0])
                                ...
                                .each(function (t, e) {
                                    ...
                                    if (n.mData === t) {
                                        ...
                                        (null === a && null === r) ||
                                            ((n.mData = { _: t + ".display", sort: null !== a ? t + ".@data-" + a : j, type: null !== a ? t + ".@data-" + a : j, filter: null !== r ? t + ".@data-" + r : j }), x(c, t));
                                    }
                                });
                        }
                        var g = c.oFeatures;
                        t = function () {
                            ...
                            if (
                                ...
                                0 === e.length || 0 === e.children().length ? i.addClass(f.sNoFooter) : 0 < e.length && ((c.nTFoot = e[0]), B(c.aoFooter, c.nTFoot)),
                                a.aaData)
                            )
            ...
            iterator: function (t, e, n, a) {
                ...
                for ("string" == typeof t && ((a = n), (n = e), (e = t), (t = !1)), o = 0, i = d.length; o < i; o++) {
                    ...
                    if ("table" === e) (r = n.call(p, d[o], o)) !== j && f.push(r);
                        ...
                        for (c = this[o], "column-rows" === e && (u = Te(d[o], h.opts)), l = 0, s = c.length; l < s; l++)
    ...
    var De = function (t, e, n, a, r) {
        ...
        ye = function (t) {
            return t || (t = {}), t.filter && t.search === j && (t.search = t.filter), P.extend({ search: "none", order: "current", page: "all" }, t);
        },
        _e = function (t) {
    ...
    Xt("columns()", function (e, n) {
        ...
        Xt("cells()", function (g, t, b) {
            ...
            var n,
                ...
                e = this.iterator(
                    "table",
                    function (t, e) {
                        for (n = [], a = 0, r = s[e].length; a < r; a++) for (o = 0, i = l[e].length; o < i; o++) n.push({ row: s[e][a], column: l[e][o] });
                        return n;
                    },
                    1
                );
        ...
        P.extend(Ut, { afnFiltering: Ut.search, aTypes: Ut.type.detect, ofnSearch: Ut.type.search, oSort: Ut.type.order, afnSortData: Ut.order, aoFeatures: Ut.feature, oApi: Ut.internal, oStdClasses: Ut.classes, oPagination: Ut.pager }),
    ...
    (function (n) {
        ...
        return (
            v.extend(!0, o.defaults, { dom: "<'row'<'col-sm-12 col-md-6'l><'col-sm-12 col-md-6'f>><'row'<'col-sm-12'tr>><'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7'p>>", renderer: "bootstrap" }),
            v.extend(o.ext.classes, { sWrapper: "dataTables_wrapper dt-bootstrap4", sFilterInput: "form-control", sLengthSelect: "form-control", sProcessing: "dataTables_processing card", sPageButton: "paginate_button page-item" }),
                    ...
                    S = function (t, e) {
                        ...
                        for (n = 0, a = e.length; n < a; n++)
                            if (((o = e[n]), v.isArray(o))) S(t, o);
                                ...
                                f &&
                                    ((r = v("<li>", { class: p.sPageButton + " " + d, id: 0 === s && "string" == typeof o ? l.sTableId + "_" + o : null })
                                        .append(v("<a>", { href: "#", "aria-controls": l.sTableId, "aria-label": b[o], "data-dt-idx": m, tabindex: l.iTabIndex, class: "page-link" }).html(f))
                                        .appendTo(t)),
