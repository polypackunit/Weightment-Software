...
<body class="overflow-hidden">
	...
	<section class="fxt-template-layout22" data-bg-image="{{ asset('auth_assets/img/figure/bg22-l.jpg')}}">
					...
					<div class="fxt-content">
						...
						<div class="fxt-form">
							...
							<form method="POST" action="{{ route('password.email') }}">
								...
								<div class="form-group">
									<button type="submit" class="fxt-btn-fill">Email Password Reset Link</button>
								</div>
							</form>
						</div>
					</div>
